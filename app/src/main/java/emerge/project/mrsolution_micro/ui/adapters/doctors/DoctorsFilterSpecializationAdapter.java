 ...
 */
public class DoctorsFilterSpecializationAdapter extends RecyclerView.Adapter<DoctorsFilterSpecializationAdapter.MyViewHolder> {

    Context mContext;
    ArrayList<Specialization> specItems;
    DoctorsPresenter doctorsPresenter;

    public DoctorsFilterSpecializationAdapter(Context mContext, ArrayList<Specialization> item, DoctorsView doctorsView) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.textvieDocname.setText(specialization.getName());
        ...
        holder.relativeLayoutMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(specialization.isSelect()){
                    ...
                    doctorsPresenter.addSpecToDocFilterStart(specialization,false);
                }else {
                    specItems.get(position).setSelect(true);
                    doctorsPresenter.addSpecToDocFilterStart(specialization,true);
                }
